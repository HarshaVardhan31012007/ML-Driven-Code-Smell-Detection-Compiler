...
async function executeCode() {
    try {
        if (!currentCodeType) {
            outputDisplay.innerHTML = '<div class="error"><strong><i class="fas fa-info-circle"></i> Select a sample first:</strong> choose Vulnerable or Clean, then execute.</div>';
            statusBadge.innerHTML = '<i class="fas fa-exclamation-circle"></i> Select sample';
...
async function analyzeCode() {
    try {
        if (!currentCodeType) {
            outputDisplay.innerHTML = '<div class="error"><strong><i class="fas fa-info-circle"></i> Select a sample first.</strong></div>';
            return;
        }
